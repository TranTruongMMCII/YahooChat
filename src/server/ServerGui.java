...
public class ServerGui {
	...
	private void initialize() {
		...
		lblNhom.setIcon(new javax.swing.ImageIcon(ServerGui.class.getResource("/image/yahoo.jpg")));
		...
		JMenuItem mntmMe = new JMenuItem(new AbstractAction("Me") {
		    /**
			 * 
			 */
			...
			public void actionPerformed(ActionEvent e) {
		    	...
		    	JOptionPane
				.showMessageDialog(frmServerMangement, 
						"Ứng dụng Yahoo chat\n"
						+ "Tác giả: Trần Văn Đan Trường\n"
						+ "Lớp: 18DMT\n"
		...
		JMenuItem mntmSoftware = new JMenuItem(new AbstractAction("Software") {
		    /**
			 * 
			 */
			private static final long serialVersionUID = 1L;
			...
			public void actionPerformed(ActionEvent e) {
				...
				.showMessageDialog(frmServerMangement, 
						"Ứng dụng Yahoo chat\n"
						+ "Sản phẩm được viết bởi ngôn ngữ lập trình Java");
		    }
		});
